...
import cn.dancingsnow.gtm_core.EPCore;
...
public class EPCoreRecipes {

    public static void addMixerRecipes(Consumer<FinishedRecipe> provider) {
        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_mv"))
                ...
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_MV, 12)
                .EUt(GTValues.VA[GTValues.MV]).duration(200)
                .save(provider);

        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_hv"))
                ...
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_HV, 40)
                .EUt(GTValues.VA[GTValues.HV]).duration(200)
                .save(provider);

        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_ev"))
                .inputItems(TagPrefix.dust, GTMaterials.Uranium238)
                .inputItems(TagPrefix.dust, GTMaterials.Platinum, 3)
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_EV,4)
                .EUt(GTValues.VA[GTValues.EV]).duration(200)
                .save(provider);

        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_iv"))
                .inputItems(TagPrefix.dust, GTMaterials.Vanadium)
                .inputItems(TagPrefix.dust, GTMaterials.Indium, 3)
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_IV, 4)
                .EUt(GTValues.VA[GTValues.IV]).duration(200)
                .save(provider);

        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_luv"))
                ...
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_LuV, 30)
                .EUt(GTValues.VA[GTValues.LuV]).duration(200)
                .save(provider);

        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_zpm"))
                ...
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_ZPM, 15)
                .EUt(GTValues.VA[GTValues.ZPM]).duration(200)
                .save(provider);

        MIXER_RECIPES.recipeBuilder(EPCore.id("superconductor_base_uv"))
                ...
                .outputItems(TagPrefix.dust, EPCoreMaterials.SUPERCONDUCTOR_BASE_UV)
